...
# Function URL public 호출 권한 (auth NONE이라도 별도 필요)
resource "aws_lambda_permission" "dashboard_api_url_public" {
...
output "dashboard_api_url" {
  ...
  description = "Dashboard API Function URL (app.js의 API_BASE에 입력)"
}
